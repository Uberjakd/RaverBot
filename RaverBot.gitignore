(function () {
    ...
    localStorage.setItem("basicBotsettings", JSON.stringify({
        ...
        skipPosition: 3,
        skipReasons: [
            ["theme", "This track is not EDM "],
            ["op", "This song is overplayed. "],
            ["history", "Not again this track! "],
            ["mix", "You're not allowed to play a mix here. "],
            ["sound", "The song you played had a bad sound quality. "],
            ["nsfw", "The song you contained was NSFW. "],
